                                                ...
                                                <i class="fa fa-bars"></i>
                                                      ...
                                                      <div class="collapse navbar-collapse" id="menu">
                                                            <ul class="nav navbar-nav navbar-right">
                                                                  <li><a href="alunohome.php" onclick="location.href='alunohome.php'">Mapa de Salas</a></li>
                                                                  <li><a href="alunohistorico.php" onclick="location.href='alunohistorico.php'">Minhas Requisições</a></li>
