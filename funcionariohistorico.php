                              ...
                              <div class="container">
                                    <div class="row">
                                                ...
                                                <i class="fa fa-bars"></i>
                                                      ...
                                                      <div class="collapse navbar-collapse" id="menu">
                                                            <ul class="nav navbar-nav navbar-right">
                                                                  <li><a href="funcionariohome.php" onclick="location.href='funcionariohome.php'">Requisições</a></li>
                                                                  <li><a href="funcionariohistorico.php" onclick="location.href='funcionariohistorico.php'">Histórico</a></li>
              						...
              						<ul class="dropdown-menu">
               						<li><a href="logoutadm.php?logout" onclick="location.href='logoutadm.php'"><span class="glyphicon glyphicon-log-out"></span>&nbsp;Sair</a></li>
              						</ul>
            						</li>
                                                            </ul>
                                                      </div>
