   ...
   /* if ( isset($_SESSION['user'])!="" ) {
    ...
    if( isset($_POST['btn-login']) ) {
        ...
        if (!$error) {
            ...
            $res=mysql_query("SELECT userID, userName, userPass FROM administrador WHERE userEmail='$email'");
           ...
           /*     $sql = "SELECT * FROM users";
              ...
              //  if ($_user_tipo == 0) 
              //  {
                	header('Location: funcionariohome.php');
             //   } elseif ($_user_tipo == 1) 
               // {
                                                ...
                                                <i class="fa fa-bars"></i>
                                                      ...
                                                      <div class="collapse navbar-collapse" id="menu">
                                                            <ul class="nav navbar-nav navbar-right">
                                                                  ...
                                                                  <li><a href="loginadm.php" onclick="location.href='loginadm.php'">Login</a></li>
                                                        <!--            <li><a href="registeradm.php" onclick="location.href='registeradm.php'">Cadastro</a></li> -->
                                                            </ul>
                                                      </div>
                                                      <!-- /.Navbar-collapse -->
                                                </div>
			    ...
			    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
			    	...
			    	<div class="col-md-12">
			        	...
			        	<div class="form-group">
			            	<h2 class="">Login Administrador</h2>
			            </div>
